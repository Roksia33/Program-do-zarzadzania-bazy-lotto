...
def save_to_database():
    try:
        ...
        cursor.execute("INSERT INTO lotto_results (lotto_type, number1, number2, number3, number4, number5, number6, date, time) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
label1 = tk.Label(root, text="", font=("Helvetica", 7)).grid(row=7, column=3)
...
button_exit = tk.Button(root, text="Wyjście",height = 2, width = 10, bg='#f49504', command=exit_program, font=("Helvetica", 10))
