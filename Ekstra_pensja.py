...
def save_to_database():
    try:
        ...
        cursor.execute("INSERT INTO lotto_results (lotto_type, number1, number2, number3, number4, number5, e_number1) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
button_exit = tk.Button(root, text="Wyjście",height = 2, width = 10, bg='#6aad32', command=root.quit, font=("Helvetica", 10))
