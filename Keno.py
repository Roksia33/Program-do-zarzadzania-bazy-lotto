...
godzina_label = tk.Label(root, text="Wpisz godzinę:", font=("Helvetica", 14))
godzina_label.grid(row=6, column=0)

# Lista opcji dla godziny
option_time = tk.Entry(root)
...
button_exit = tk.Button(root, text="Wyjście",height = 2, width = 10, bg='#fc851a', command=exit_program, font=("Helvetica", 10))
