...
apply_button = tk.Button(root, text="Zastosuj", height = 2, width = 10, bg='#fc851a', command=toggle_entry_state).grid(row=2, column=2)
...
tk.Label(root, text="Liczby (1-70):", font=("Helvetica", 14)).grid(row=4, column=0)
number_entries = []
for i in range(10):
...
button_refresh = tk.Button(root, text="Resetuj", height = 2, width = 10, bg='#fc851a', command=refresh_data, font=("Helvetica", 10))
button_refresh.grid(row=8, column=2)
save_button = tk.Button(root, text="Zapisz",height = 2, width = 10, bg='#fc851a', command=save_to_database, font=("Helvetica", 10))
save_button.grid(row=8, column=3)
button_exit = tk.Button(root, text="Wyjście",height = 2, width = 10, bg='#fc851a', command=root.quit, font=("Helvetica", 10))
