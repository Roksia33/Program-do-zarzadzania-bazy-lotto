...
label = tk.Label(root, text="", font=("Helvetica", 19)).grid(row=4, column=3)
...
button_exit = tk.Button(root, text="Wyjście",height = 2, width = 10, bg='#3cc6e0', command=exit_program, font=("Helvetica", 10))
