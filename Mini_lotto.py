...
apply_button = tk.Button(root, text="Zastosuj", height = 2, width = 10, bg='#fdca51', command=toggle_entry_state).grid(row=2, column=2)
...
button_exit = tk.Button(root, text="Wyjście",height = 2, width = 10, bg='#fdca51', command=root.quit, font=("Helvetica", 10))
